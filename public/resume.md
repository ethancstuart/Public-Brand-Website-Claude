...
Expanded from CDP to the full platform portfolio after demonstrating rapid impact.
Staff Product Manager, Enterprise Customer Data Platform	    June 2023 - January 2025
Scope: All Yum brands — Taco Bell, KFC, Pizza Hut · 14-person team across product, engineering, and analytics
Drove CDP adoption across Taco Bell, KFC, and Pizza Hut — led implementation and GTM enabling 80% YoY loyalty growth (CDP contribution validated via marketing mix model).
...
Established a data governance framework with proactive quality monitoring and stakeholder notification, in a highly regulated context.
...
The Data Product Agent (thedataproductagent.substack.com) — Data products, AI-native team operating models, multi-agent systems, and building enterprise software through AI coding tools.
...
Databricks Academy — Generative AI Fundamentals + Lakehouse Fundamentals (Credential IDs: 112741113, 112676552)
